Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/microsoft/fluentui-apple.git", :tag => "0.2.3" }
  s.swift_version = "5.0"
...
# iOS
  ...
  s.subspec 'Avatar_ios' do |avatar_ios|
    ...
    avatar_ios.resource_bundle = { 'MicrosoftFluentUI_Avatar_ios' => ["ios/FluentUI/**/*.{storyboard,xib,xcassets,strings,stringsdict}"] }
  end

  s.subspec 'Core_ios' do |core_ios|
    core_ios.platform = :ios
    core_ios.resource_bundle = { 'MicrosoftFluentUI_Core_ios' => ["apple/Resources/**/*.{json,xcassets}"] }
