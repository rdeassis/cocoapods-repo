Pod::Spec.new do |s|
  ...
  s.resource_bundle = { 'FluentUIResources-ios' => [] }
...
# iOS
  ...
  s.subspec 'Avatar_ios' do |avatar_ios|
    ...
    s.resource_bundle = { 'FluentUIResources-ios' => ["ios/FluentUI/**/*.{storyboard,xib,xcassets,strings,stringsdict}"] }
  end
  ...
  s.subspec 'Core_ios' do |core_ios|
    ...
    s.resource_bundle = { 'FluentUIResources-ios' => ["apple/Resources/**/*.{json,xcassets}"] }
